  ...
  missions: [
    ...
    /* ═══════════════  TIER 2 — Conosciuto/Noto (50+ fama) ═══════════════ */
    {
      ...
      approaches: [
        ...
        { label: "Trovare il percorso sicuro", stat: "int", dc: 16,
    ...
    },
    {
      ...
      approaches: [
        ...
        { label: "Convincere un servitore", stat: "cha", dc: 16,
    ...
    },
    {
      ...
      approaches: [
        ...
        { label: "Affrontarla di forza", stat: "str", dc: 16,
    ...
    },
    {
      ...
      approaches: [
        ...
        { label: "Individuare i documenti rapidamente", stat: "int", dc: 17,
    ...
    },
    {
      ...
      type: "spionaggio",
      approaches: [
        { label: "Ascoltare attraverso il muro", stat: "wis", dc: 17,
        ...
        { label: "Decifrare i messaggi lasciati", stat: "int", dc: 16,
    ...
    },
    {
      ...
      approaches: [
        ...
        { label: "Pianificare ogni secondo", stat: "int", dc: 17,
    ...
    },
    {
      ...
      approaches: [
        ...
        { label: "Creare diversivi convincenti", stat: "int", dc: 17,
    ...
    },
    {
      ...
      approaches: [
        ...
        { label: "Affrontarlo di petto", stat: "str", dc: 17,
    ...
    },
    {
      ...
      type: "recupero",
      approaches: [
        { label: "Localizzare e analizzare", stat: "int", dc: 16,
    ...
    },
    {
      ...
      type: "infiltrazione",
      approaches: [
        { label: "Fingersi un membro", stat: "cha", dc: 17,
    ...
    },
    {
      ...
      approaches: [
        ...
        { label: "Usare un intermediario", stat: "cha", dc: 16,
    ...
    },
    {
      ...
      approaches: [
        ...
        { label: "Convincere il palafreniere", stat: "cha", dc: 16,
    ...
    /* ═══════════════  TIER 3 — Noto+ (150+ fama) ═══════════════ */
    {
      ...
      type: "furto",
      approaches: [
        { label: "Operazione ombra", stat: "dex", dc: 20,
    ...
    },
    {
      ...
      approaches: [
        ...
        { label: "Sfida diretta", stat: "str", dc: 20,
    ...
    },
    {
      ...
      approaches: [
        ...
        { label: "Trovare la via segreta", stat: "int", dc: 20,
    ...
    },
    {
      ...
      type: "recupero",
      approaches: [
        { label: "Rubare mentre dorme", stat: "dex", dc: 20,
        ...
        { label: "Decifrare le protezioni magiche", stat: "int", dc: 20,
    ...
    },
    {
      ...
      type: "eliminazione",
      approaches: [
        { label: "Veleno nel vino", stat: "dex", dc: 20,
    ...
    },
    {
      ...
      type: "furto",
      approaches: [
        { label: "Ingannarlo con un affare falso", stat: "cha", dc: 20,
        ...
        { label: "Svuotare il forziere di notte", stat: "int", dc: 20,
    ...
    },
    {
      ...
      type: "sabotaggio",
      approaches: [
        { label: "Bruciare l'archivio", stat: "dex", dc: 20,
        ...
        { label: "Falsificare i documenti", stat: "int", dc: 20,
    ...
    },
    {
      ...
      approaches: [
        ...
        { label: "Decifrare dove si dirige", stat: "int", dc: 20,
    ...
    /* ═══════════════  MAGO — TIER 2 (50+ fama) ═══════════════ */
    {
      ...
      type: "esplorazione",
      approaches: [
        { label: "Spezzare la maledizione", stat: "int", dc: 16,
        ...
        { label: "Combattere con la forza bruta", stat: "str", dc: 18,
    ...
    },
    {
      ...
      type: "infiltrazione",
      approaches: [
        { label: "Infiltrarti come simpatizzante", stat: "cha", dc: 16,
        ...
        { label: "Decifrare i loro simboli", stat: "int", dc: 18,
    ...
    },
    {
      ...
      approaches: [
        { label: "Disattivare il core magico", stat: "int", dc: 16,
        ...
        { label: "Abbatterlo fisicamente", stat: "str", dc: 18,
    ...
    },
    {
      ...
      type: "neutralizzazione",
      approaches: [
        { label: "Ragionare con lui", stat: "int", dc: 15,
        ...
        { label: "Intuire dove si trova la coscienza", stat: "wis", dc: 17,
    ...
    },
    {
      ...
      type: "eliminazione",
      approaches: [
        { label: "Bruciare la tana con la magia del fuoco", stat: "int", dc: 16,
        ...
        { label: "Muoversi silenziosamente ed eliminarli", stat: "dex", dc: 18,
    ...
    },
    {
      ...
      type: "recupero",
      approaches: [
        { label: "Usare la sfera per trovarsi", stat: "int", dc: 15,
        ...
        { label: "Intuire dove si nasconde il ladro", stat: "wis", dc: 17,
    ...
    },
    {
      ...
      type: "liberazione",
      approaches: [
        { label: "Trovare la clausola di uscita", stat: "wis", dc: 16,
        ...
        { label: "Riscrivere il contratto con la magia", stat: "int", dc: 18,
    ...
    },
    {
      ...
      type: "sigillo",
      approaches: [
        { label: "Sigillare il portale con rune", stat: "int", dc: 17,
        ...
        { label: "Percepire le frequenze del piano", stat: "wis", dc: 16,
    ...
    },
    {
      ...
      type: "liberazione",
      approaches: [
        { label: "Cercare il rituale di rottura", stat: "wis", dc: 16,
        ...
        { label: "Convincere la luna con la persuasione arcana", stat: "cha", dc: 17,
    ...
    },
    {
      ...
      type: "competizione",
      approaches: [
        { label: "Dominare le prove teoriche", stat: "int", dc: 16,
        ...
        { label: "Convincere i giudici con il portamento", stat: "cha", dc: 17,
    ...
    /* ═══════════════  MAGO — TIER 3 (150+ fama) ═══════════════ */
    {
      ...
      type: "eliminazione",
      approaches: [
        { label: "Smontare i suoi rituali di legame", stat: "int", dc: 20,
        ...
        { label: "Affrontarlo fisicamente", stat: "str", dc: 20,
    ...
    },
    {
      ...
      type: "ripristino",
      approaches: [
        { label: "Ridisegnare le rune originali", stat: "int", dc: 20,
        ...
        { label: "Meditare sull'essenza del sigillo", stat: "wis", dc: 20,
    ...
    },
    {
      ...
      type: "indagine",
      approaches: [
        { label: "Ricostruire la profezia completa", stat: "wis", dc: 20,
        ...
        { label: "Trovare chi vuole seppellirla", stat: "int", dc: 20,
    ...
    },
    {
      ...
      type: "recupero",
      approaches: [
        { label: "Navigare il piano etereo", stat: "int", dc: 20,
        ...
        { label: "Sentire la risonanza dell'artefatto", stat: "wis", dc: 20,
    ...
    },
    {
      ...
      type: "impedimento",
      approaches: [
        { label: "Interrompere il rituale del risveglio", stat: "int", dc: 20,
        ...
        { label: "Distruggere la phylactery", stat: "str", dc: 20,
    ...
    },
    {
      ...
      type: "infiltrazione",
      approaches: [
        { label: "Disattivare i sigilli dall'interno", stat: "int", dc: 20,
        ...
        { label: "Sgattaiolare tra le maglie dei sigilli", stat: "dex", dc: 20,
    ...
    },
    {
      ...
      type: "spionaggio",
      approaches: [
        { label: "Fingersi un lich appena risorto", stat: "cha", dc: 20,
        ...
        { label: "Decifrare le loro comunicazioni segrete", stat: "int", dc: 20,
    ...
    },
    {
      ...
      type: "recupero",
      approaches: [
        { label: "Tracciare la sua risonanza unica", stat: "int", dc: 20,
        ...
        { label: "Meditare sulla sua essenza universale", stat: "wis", dc: 20,
    ...
    },
    {
      ...
      type: "duello",
      approaches: [
        { label: "Trovare il suo punto debole arcano", stat: "int", dc: 20,
        ...
        { label: "Percepire la fonte della sua immortalità", stat: "wis", dc: 20,
    ...
    },
    {
      ...
      type: "prevenzione",
      approaches: [
        { label: "Riequilibrare le linee di potere", stat: "int", dc: 20,
        ...
        { label: "Assorbire l'eccesso di potere", stat: "wis", dc: 20,
    ...
    /* ═══════════════  DRUIDO — TIER 2 (50+ fama) ═══════════════ */
    {
      ...
      type: "bonifica",
      approaches: [
        { label: "Trovare e purificare il nucleo della corruzione", stat: "wis", dc: 16,
        ...
        { label: "Coordinare gli spiriti della foresta", stat: "int", dc: 18,
    ...
    },
    {
      ...
      type: "incantesimo",
      approaches: [
        { label: "Negoziare con gli spiriti degli animali", stat: "wis", dc: 15,
        ...
        { label: "Far comprendere al cacciatore il suo errore", stat: "cha", dc: 17,
    ...
    },
    {
      ...
      type: "rituale",
      approaches: [
        { label: "Eseguire il rituale della pioggia antico", stat: "int", dc: 16,
        ...
        { label: "Trovare la fonte magica della siccità", stat: "wis", dc: 17,
    ...
    },
    {
      ...
      type: "negoziazione",
      approaches: [
        { label: "Ascoltare e comprendere le richieste degli spiriti", stat: "wis", dc: 16,
        ...
        { label: "Placare gli spiriti con un'offerta", stat: "cha", dc: 17,
    ...
    },
    {
      ...
      type: "cura",
      approaches: [
        { label: "Trovare la cura nella natura", stat: "wis", dc: 16,
        ...
        { label: "Affrontare il lupo mannaro durante la luna piena", stat: "str", dc: 18,
    ...
    },
    {
      ...
      type: "purificazione",
      approaches: [
        { label: "Rimuovere le rune con un rituale di purificazione", stat: "wis", dc: 17,
        ...
        { label: "Analizzare la natura delle rune", stat: "int", dc: 16,
    ...
    },
    {
      ...
      type: "bonifica",
      approaches: [
        { label: "Comunicare con le piante e spostarle", stat: "wis", dc: 16,
        ...
        { label: "Muoversi tra i tentacoli con velocità", stat: "dex", dc: 17,
    ...
    },
    {
      ...
      type: "indagine",
      approaches: [
        { label: "Cercare lo spirito nei piani paralleli", stat: "wis", dc: 16,
        ...
        { label: "Convincere il villaggio a usare i propri rituali", stat: "cha", dc: 17,
    ...
    },
    {
      ...
      type: "cura",
      approaches: [
        { label: "Trovare e distribuire la cura naturale", stat: "wis", dc: 15,
        ...
        { label: "Isolare e studiare la malattia", stat: "int", dc: 17,
    ...
    },
    {
      ...
      type: "risveglio",
      approaches: [
        { label: "Risvegliare la driade con un canto della natura", stat: "wis", dc: 16,
        ...
        { label: "Comprendere il motivo del sonno eterno", stat: "cha", dc: 18,
    ...
    /* ═══════════════  DRUIDO — TIER 3 (150+ fama) ═══════════════ */
    {
      ...
      type: "confronto",
      approaches: [
        { label: "Parlare al Re della Foresta come suo pari", stat: "wis", dc: 20,
        ...
        { label: "Combattere lo spirito fisicamente", stat: "str", dc: 20,
    ...
    },
    {
      ...
      type: "indagine",
      approaches: [
        { label: "Interpretare i segni della natura", stat: "wis", dc: 20,
        ...
        { label: "Trovare i testi druidici che parlano della profezia", stat: "int", dc: 20,
    ...
    },
    {
      ...
      type: "purificazione",
      approaches: [
        { label: "Purificare il guardiano con un rituale di luce", stat: "wis", dc: 20,
        ...
        { label: "Combattere fisicamente il guardiano corrotto", stat: "str", dc: 20,
    ...
    },
    {
      ...
      type: "ripristino",
      approaches: [
        { label: "Trovare e annullare l'incantesimo dell'inversione", stat: "wis", dc: 20,
        ...
        { label: "Studiare la nuova gerarchia e adattarsi", stat: "int", dc: 20,
    ...
    },
    {
      ...
      type: "sigillo",
      approaches: [
        { label: "Sigillare il portale con la forza della vita", stat: "wis", dc: 20,
        ...
        { label: "Negoziare con le creature elementali", stat: "int", dc: 20,
    ...
    },
    {
      ...
      type: "intervento",
      approaches: [
        { label: "Invocare la pioggia con un grande rituale", stat: "wis", dc: 20,
        ...
        { label: "Trovare e rimuovere la fonte magica dell'incendio", stat: "dex", dc: 20,
    ...
    },
    {
      ...
      type: "indagine",
      approaches: [
        { label: "Partecipare al conclave come druido", stat: "wis", dc: 20,
        ...
        { label: "Guidare il conclave verso la soluzione", stat: "cha", dc: 20,
    ...
    },
    {
      ...
      type: "purificazione",
      approaches: [
        { label: "Bloccare la corruzione alla fonte", stat: "wis", dc: 20,
        ...
        { label: "Creare una barriera vegetale purificatrice", stat: "int", dc: 20,
    ...
    },
    {
      ...
      type: "prevenzione",
      approaches: [
        { label: "Placare l'essere con il rito del sonno eterno", stat: "wis", dc: 20,
        ...
        { label: "Combattere l'essere mentre è ancora assonnato", stat: "str", dc: 20,
    ...
    },
    {
      ...
      type: "prevenzione",
      approaches: [
        { label: "Assorbire personalmente l'eccesso energetico", stat: "wis", dc: 20,
          ...
          failText: "L'energia è troppa. Il tuo corpo non regge. Fuggi." },
        { label: "Trovare e riparare il ciclo naturale spezzato", stat: "int", dc: 20,
    ...
    /* ═══════════════  GUERRIERO — TIER 2 (50+ fama) ═══════════════ */
    {
      ...
      type: "combattimento",
      approaches: [
        { label: "Assalto frontale", stat: "str", dc: 16,
        ...
        { label: "Resistere al loro contrattacco", stat: "con", dc: 16,
    ...
    },
    {
      ...
      type: "competizione",
      approaches: [
        { label: "Combattere con potenza bruta", stat: "str", dc: 17,
        ...
        { label: "Muoversi con precisione", stat: "dex", dc: 16,
    ...
    },
    {
      ...
      type: "caccia",
      approaches: [
        { label: "Affrontarlo a viso aperto", stat: "str", dc: 17,
        ...
        { label: "Resistere alla sua furia", stat: "con", dc: 16,
    ...
    },
    {
      ...
      type: "difesa",
      approaches: [
        { label: "Guidare la difesa in prima linea", stat: "str", dc: 16,
        ...
        { label: "Organizzare la resistenza tattica", stat: "wis", dc: 17,
    ...
    },
    {
      ...
      type: "neutralizzazione",
      approaches: [
        { label: "Immobilizzarlo con la forza", stat: "str", dc: 17,
        ...
        { label: "Stancarsi del suo attacco", stat: "con", dc: 16,
    ...
    /* ═══════════════  GUERRIERO — TIER 3 (150+ fama) ═══════════════ */
    {
      ...
      type: "duello",
      approaches: [
        { label: "Superarlo in potenza", stat: "str", dc: 20,
        ...
        { label: "Resistere e contrattaccare", stat: "con", dc: 20,
    ...
    },
    {
      ...
      type: "assedio",
      approaches: [
        { label: "Guidare la carica attraverso le mura", stat: "str", dc: 20,
        ...
        { label: "Resistere al fuoco di sbarramento", stat: "con", dc: 20,
    ...
    },
    {
      ...
      type: "caccia",
      approaches: [
        { label: "Affrontarlo in combattimento aperto", stat: "str", dc: 20,
        ...
        { label: "Resistere al suo alito di fuoco", stat: "con", dc: 20,
    ...
    },
    {
      ...
      type: "neutralizzazione",
      approaches: [
        { label: "Affrontarlo e sconfiggerlo", stat: "str", dc: 20,
        ...
        { label: "Convincere la sua guardia a tradirlo", stat: "cha", dc: 20,
    ...
    },
    {
      ...
      type: "battaglia",
      approaches: [
        { label: "Guidare la controffensiva", stat: "str", dc: 20,
        ...
        { label: "Resistere all'ultima linea", stat: "con", dc: 20,
    ...
    /* ═══════════════  PALADINO — TIER 2 (50+ fama) ═══════════════ */
    {
      ...
      type: "sigillo",
      approaches: [
        { label: "Combattere i non morti all'interno", stat: "str", dc: 16,
        ...
        { label: "Resistere alla loro aura di morte", stat: "con", dc: 16,
    ...
    },
    {
      ...
      type: "indagine",
      approaches: [
        { label: "Smascherarli con un discorso pubblico", stat: "cha", dc: 17,
        ...
        { label: "Leggere i segni oscuri del culto", stat: "wis", dc: 16,
    ...
    },
    {
      ...
      type: "duello",
      approaches: [
        { label: "Affrontarlo in combattimento sacro", stat: "str", dc: 17,
        ...
        { label: "Resistere ai suoi colpi maledetti", stat: "con", dc: 16,
    ...
    },
    {
      ...
      type: "liberazione",
      approaches: [
        { label: "Sfondare le porte del dungeon", stat: "str", dc: 16,
        ...
        { label: "Convincere le guardie ad aprire", stat: "cha", dc: 17,
    ...
    },
    {
      ...
      type: "purificazione",
      approaches: [
        { label: "Punire i saccheggiatori", stat: "str", dc: 16,
        ...
        { label: "Purificare l'energia del tempio", stat: "wis", dc: 17,
    ...
    /* ═══════════════  PALADINO — TIER 3 (150+ fama) ═══════════════ */
    {
      ...
      type: "eliminazione",
      approaches: [
        { label: "Distruggerlo con la forza sacra", stat: "str", dc: 20,
        ...
        { label: "Resistere alla sua aura di terrore", stat: "con", dc: 20,
    ...
    },
    {
      ...
      type: "esorcismo",
      approaches: [
        { label: "Sfidarlo con la parola divina", stat: "cha", dc: 20,
        ...
        { label: "Leggere i segni del suo arrivo", stat: "wis", dc: 20,
    ...
    },
    {
      ...
      type: "battaglia",
      approaches: [
        { label: "Guidare la carica santa", stat: "str", dc: 20,
        ...
        { label: "Ispirar il coraggio nell'esercito", stat: "cha", dc: 20,
    ...
    },
    {
      ...
      type: "duello",
      approaches: [
        { label: "Combatterlo e sconfiggerlo", stat: "str", dc: 20,
        ...
        { label: "Tentare la redenzione", stat: "cha", dc: 20,
    ...
    },
    {
      ...
      type: "pace",
      approaches: [
        { label: "Imporre la pace con la forza", stat: "str", dc: 20,
        ...
        { label: "Negoziare tra le fazioni", stat: "cha", dc: 20,
    ...
    /* ═══════════════  CHIERICO — TIER 2 (50+ fama) ═══════════════ */
    {
      ...
      type: "guarigione",
      approaches: [
        { label: "Canale di guarigione di massa", stat: "wis", dc: 16,
        ...
        { label: "Resistere alla malattia per curarli", stat: "con", dc: 16,
    ...
    },
    {
      ...
      type: "indagine",
      approaches: [
        { label: "Smascherarli davanti ai fedeli", stat: "cha", dc: 17,
        ...
        { label: "Leggere i segni della corruzione", stat: "wis", dc: 16,
    ...
    },
    {
      ...
      type: "esorcismo",
      approaches: [
        { label: "Rituale di rottura della maledizione", stat: "wis", dc: 17,
        ...
        { label: "Persuadere la famiglia a collaborare", stat: "cha", dc: 16,
    ...
    },
    {
      ...
      type: "giustizia",
      approaches: [
        { label: "Difenderlo pubblicamente", stat: "cha", dc: 16,
        ...
        { label: "Trovare prove teologiche della sua innocenza", stat: "wis", dc: 17,
    ...
    },
    {
      ...
      type: "esorcismo",
      approaches: [
        { label: "Esorcizzarlo con parole divine", stat: "cha", dc: 17,
        ...
        { label: "Resistere alla sua aura corruttrice", stat: "con", dc: 16,
    ...
    /* ═══════════════  CHIERICO — TIER 3 (150+ fama) ═══════════════ */
    {
      ...
      type: "guarigione",
      approaches: [
        { label: "Invocazione di guarigione divina di massa", stat: "wis", dc: 20,
        ...
        { label: "Resistere all'epidemia mentre curi", stat: "con", dc: 20,
    ...
    },
    {
      ...
      type: "esorcismo",
      approaches: [
        { label: "Pronunciare la condanna divina", stat: "cha", dc: 20,
        ...
        { label: "Leggere i loro nomi veri", stat: "wis", dc: 20,
    ...
    },
    {
      ...
      type: "sigillo",
      approaches: [
        { label: "Rituale di rinforzo del sigillo", stat: "wis", dc: 20,
        ...
        { label: "Resistere all'influenza del dio che cerca di uscire", stat: "con", dc: 20,
    ...
    },
    {
      ...
      type: "confronto",
      approaches: [
        { label: "Sfidarlo in una disputa pubblica", stat: "cha", dc: 20,
        ...
        { label: "Smascherarne la falsità con la saggezza divina", stat: "wis", dc: 20,
    ...
    },
    {
      ...
      type: "sigillo",
      approaches: [
        { label: "Guidare il grande rituale di sigillatura", stat: "wis", dc: 20,
        ...
        { label: "Convincere i sacerdoti rivali a collaborare", stat: "cha", dc: 20,
...
const ENEMIES = [
  { id: 'ratto_gigante',     name: 'Ratto Gigante',       tier: 1, icon: '🐀',
    hp: 28, stats: { str:10, dex:14, con:12, int:4, wis:6, cha:4 },
    defense: 0, magicResist: 0, accuracy: 0, evasion: 0, attackBonus: 1, damageDice: '1d8',
  ...
  { id: 'goblin_ladro',      name: 'Goblin Ladro',        tier: 1, icon: '👺',
    hp: 35, stats: { str:13, dex:15, con:10, int:8, wis:8, cha:6 },
    defense: 1, magicResist: 0, accuracy: 0, evasion: 0, attackBonus: 1, damageDice: '1d8',
  ...
  { id: 'guardia_corrotta',  name: 'Guardia Corrotta',    tier: 1, icon: '🤺',
    hp: 46, stats: { str:16, dex:8, con:15, int:8, wis:8, cha:8 },
    defense: 3, magicResist: 0, accuracy: 0, evasion: 0, attackBonus: 1, damageDice: '1d10',
  ...
  { id: 'mercenario_oscuro', name: 'Mercenario Oscuro',   tier: 2, icon: '🗡️',
    hp: 61, stats: { str:18, dex:14, con:15, int:10, wis:9, cha:8 },
  ...
  { id: 'cultista_vuoto',    name: 'Cultista del Vuoto',  tier: 2, icon: '🌀',
    hp: 48, stats: { str:8, dex:10, con:10, int:18, wis:14, cha:10 },
  ...
  { id: 'orco_teppista',     name: 'Orco Teppista',       tier: 2, icon: '👹',
    hp: 82, stats: { str:20, dex:8, con:18, int:6, wis:7, cha:6 },
  ...
  { id: 'cavaliere_caduto',  name: 'Cavaliere Caduto',    tier: 3, icon: '🏇',
    hp: 102, stats: { str:20, dex:10, con:18, int:10, wis:10, cha:8 },
  ...
  { id: 'negromante_minore', name: 'Negromante Minore',   tier: 3, icon: '💀',
    hp: 67, stats: { str:8, dex:10, con:10, int:19, wis:16, cha:10 },
...
const COMBAT_SKILLS = [
  ...
  { id: 'attacca',             name: 'Attacca',              icon: '⚔️',
    ...
    classStat:    { guerriero: 'str', mago: 'int', paladino: 'cha', druido: 'wis', chierico: 'wis' },
