...
const ENEMIES = [
  { id: 'ratto_gigante',     name: 'Ratto Gigante',       tier: 1, icon: '🐀',
    hp: 55, mp: 0, stats: { str:10, dex:14, con:12, int:4, wis:6, cha:4 },
  ...
  { id: 'goblin_ladro',      name: 'Goblin Ladro',        tier: 1, icon: '👺',
    hp: 68, mp: 0, stats: { str:13, dex:15, con:10, int:8, wis:8, cha:6 },
  ...
  { id: 'guardia_corrotta',  name: 'Guardia Corrotta',    tier: 1, icon: '💂',
    hp: 88, mp: 0, stats: { str:16, dex:8, con:15, int:8, wis:8, cha:8 },
  ...
  { id: 'mercenario_oscuro', name: 'Mercenario Oscuro',   tier: 2, icon: '🗡️',
    hp: 118, mp: 0, stats: { str:18, dex:14, con:15, int:10, wis:9, cha:8 },
  ...
  { id: 'cultista_vuoto',    name: 'Cultista del Vuoto',  tier: 2, icon: '🌀',
    hp: 92, mp: 12, stats: { str:8, dex:10, con:10, int:18, wis:14, cha:10 },
  ...
  { id: 'orco_teppista',     name: 'Orco Teppista',       tier: 2, icon: '👹',
    hp: 158, mp: 0, stats: { str:20, dex:8, con:18, int:6, wis:7, cha:6 },
  ...
  { id: 'cavaliere_caduto',  name: 'Cavaliere Caduto',    tier: 3, icon: '🏇',
    hp: 195, mp: 0, stats: { str:20, dex:10, con:18, int:10, wis:10, cha:8 },
  ...
  { id: 'negromante_minore', name: 'Negromante Minore',   tier: 3, icon: '💀',
    hp: 128, mp: 18, stats: { str:8, dex:10, con:10, int:19, wis:16, cha:10 },
