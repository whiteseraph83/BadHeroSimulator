...
const COMBAT_SKILLS = [
  ...
  { id: 'scudo_sacro',         name: 'Scudo Sacro',          icon: '🛡️',
    ...
    target: 'self',  availableFor: ['paladino'], scalingCA: true, hitPenalty: 0, unlockLevel: 1, cooldown: 3 },
  { id: 'scudo_divino',        name: 'Scudo Divino',         icon: '✝️',
    type: 'utility',  stat: 'wis', hitStat: 'wis',
    damageDice: null,  damageBonus: 0, mpCost: 2,
    target: 'self',  availableFor: ['chierico'], scalingCA: true, hitPenalty: 0, unlockLevel: 1, cooldown: 3 },
  { id: 'armatura_corteccia',  name: 'Armatura di Corteccia',icon: '🌿',
    type: 'utility',  stat: 'wis', hitStat: 'wis',
    damageDice: null,  damageBonus: 0, mpCost: 2,
    target: 'self',  availableFor: ['druido'], scalingCA: true, hitPenalty: 0, unlockLevel: 1, cooldown: 3 },
  { id: 'evasione',            name: 'Evasione',             icon: '💨',
    type: 'utility',  stat: 'dex', hitStat: 'dex',
    damageDice: null,  damageBonus: 0, mpCost: 0,
    target: 'self',  availableFor: ['ladro'], scalingCA: true, hitPenalty: 0, unlockLevel: 1, cooldown: 3 },
  { id: 'scudo_magico',        name: 'Scudo Magico',         icon: '✨',
    type: 'utility',  stat: 'int', hitStat: 'int',
    damageDice: null,  damageBonus: 0, mpCost: 3,
    target: 'self',  availableFor: ['mago'], scalingCA: true, hitPenalty: 0, unlockLevel: 1, cooldown: 3 },
  { id: 'manovra_difensiva',   name: 'Manovra Difensiva',    icon: '🛡️',
    type: 'utility',  stat: 'con', hitStat: 'con',
    damageDice: null,  damageBonus: 0, mpCost: 0,
    target: 'self',  availableFor: ['guerriero'], scalingCA: true, hitPenalty: 0, unlockLevel: 1, cooldown: 3 },
