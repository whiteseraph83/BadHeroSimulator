...
const ENEMIES = [
  { id: 'ratto_gigante',     name: 'Ratto Gigante',       tier: 1, icon: '🐀',
    hp: 40, mp: 0, stats: { str:8, dex:14, con:12, int:4, wis:6, cha:4 },
    defense: 0, magicResist: 0, accuracy: 0, evasion: 0, damageDice: '1d6',
  ...
  { id: 'goblin_ladro',      name: 'Goblin Ladro',        tier: 1, icon: '👺',
    hp: 50, mp: 0, stats: { str:10, dex:13, con:10, int:8, wis:8, cha:6 },
    defense: 1, magicResist: 0, accuracy: 0, evasion: 0, damageDice: '1d6',
  ...
  { id: 'guardia_corrotta',  name: 'Guardia Corrotta',    tier: 1, icon: '💂',
    hp: 62, mp: 0, stats: { str:13, dex:8, con:15, int:8, wis:8, cha:8 },
    defense: 3, magicResist: 0, accuracy: 0, evasion: 0, damageDice: '1d8',
  ...
  { id: 'mercenario_oscuro', name: 'Mercenario Oscuro',   tier: 2, icon: '🗡️',
    hp: 88, mp: 0, stats: { str:15, dex:14, con:15, int:10, wis:9, cha:8 },
    defense: 2, magicResist: 0, accuracy: 0, evasion: 0, damageDice: '1d8',
  ...
  { id: 'cultista_vuoto',    name: 'Cultista del Vuoto',  tier: 2, icon: '🌀',
    hp: 68, mp: 12, stats: { str:8, dex:10, con:10, int:15, wis:14, cha:10 },
    defense: 0, magicResist: 2, accuracy: 0, evasion: 0, damageDice: '1d6',
  ...
  { id: 'orco_teppista',     name: 'Orco Teppista',       tier: 2, icon: '👹',
    hp: 115, mp: 0, stats: { str:17, dex:8, con:18, int:6, wis:7, cha:6 },
    defense: 2, magicResist: 0, accuracy: 0, evasion: -1, damageDice: '1d10',
  ...
  { id: 'cavaliere_caduto',  name: 'Cavaliere Caduto',    tier: 3, icon: '🏇',
    hp: 145, mp: 0, stats: { str:16, dex:10, con:18, int:10, wis:10, cha:8 },
    defense: 5, magicResist: 1, accuracy: 0, evasion: 0, damageDice: '1d10',
  ...
  { id: 'negromante_minore', name: 'Negromante Minore',   tier: 3, icon: '💀',
    hp: 95, mp: 18, stats: { str:8, dex:10, con:10, int:16, wis:16, cha:10 },
    defense: 0, magicResist: 3, accuracy: 0, evasion: 0, damageDice: '1d8',
