...
const ENEMIES = [
  { id: 'ratto_gigante',     name: 'Ratto Gigante',       tier: 1, icon: '🐀',
    hp: 22, mp: 0, stats: { str:6, dex:12, con:10, int:4, wis:6, cha:4 },
  ...
  { id: 'goblin_ladro',      name: 'Goblin Ladro',        tier: 1, icon: '👺',
    hp: 28, mp: 0, stats: { str:8, dex:14, con:10, int:8, wis:8, cha:6 },
  ...
  { id: 'guardia_corrotta',  name: 'Guardia Corrotta',    tier: 1, icon: '💂',
    hp: 36, mp: 0, stats: { str:12, dex:8, con:13, int:8, wis:8, cha:8 },
  ...
  { id: 'mercenario_oscuro', name: 'Mercenario Oscuro',   tier: 2, icon: '🗡️',
    hp: 52, mp: 0, stats: { str:14, dex:12, con:14, int:10, wis:9, cha:8 },
  ...
  { id: 'cultista_vuoto',    name: 'Cultista del Vuoto',  tier: 2, icon: '🌀',
    hp: 40, mp: 12, stats: { str:8, dex:10, con:10, int:15, wis:12, cha:10 },
  ...
  { id: 'orco_teppista',     name: 'Orco Teppista',       tier: 2, icon: '👹',
    hp: 68, mp: 0, stats: { str:17, dex:8, con:16, int:6, wis:7, cha:6 },
  ...
  { id: 'cavaliere_caduto',  name: 'Cavaliere Caduto',    tier: 3, icon: '🏇',
    hp: 85, mp: 0, stats: { str:16, dex:10, con:16, int:10, wis:10, cha:8 },
  ...
  { id: 'negromante_minore', name: 'Negromante Minore',   tier: 3, icon: '💀',
    hp: 56, mp: 18, stats: { str:8, dex:10, con:10, int:17, wis:14, cha:10 },
...
const COMBAT_SKILLS = [
  ...
  { id: 'fuggi',               name: 'Fuggi',                icon: '🏃',
    ...
    target: 'self',   availableFor: 'all', hitPenalty: 0, unlockLevel: 2 },
  ...
  { id: 'colpo_spalle',        name: 'Colpo alle Spalle',    icon: '🗡️',
    ...
    cooldown: 2, synergySkill: 'polvere_accecante' },
  { id: 'polvere_accecante',   name: 'Polvere Accecante',    icon: '💨',
    type: 'utility',  stat: 'dex', hitStat: 'dex',
    damageDice: null,  damageBonus: 0, mpCost: 0,
    target: 'enemy', availableFor: ['ladro'], statusApply: 'blind', hitPenalty: 0, unlockLevel: 4,
    cooldown: 2, synergySkill: 'colpo_spalle' },
  { id: 'veleno_lama',         name: 'Veleno sulla Lama',    icon: '🧪',
    ...
    cooldown: 3, synergySkill: 'polvere_accecante' },
  { id: 'nebbia_fumogena',     name: 'Nebbia Fumogena',      icon: '🌫️',
    ...
    cooldown: 3, synergySkill: 'veleno_lama' },
  { id: 'doppio_pugnale',      name: 'Doppio Pugnale',       icon: '⚡',
    type: 'physical', stat: 'dex', hitStat: 'dex',
    damageDice: '3d4', damageBonus: 0, mpCost: 0,
    target: 'enemy', availableFor: ['ladro'], hitPenalty: 0, unlockLevel: 7,
    cooldown: 4, synergySkill: 'nebbia_fumogena' },
  { id: 'ombra_letale',        name: 'Ombra Letale',         icon: '🌑',
    ...
    cooldown: 4, synergySkill: 'doppio_pugnale' },
  { id: 'colpo_mortale',       name: 'Colpo Mortale',        icon: '💀',
    ...
    cooldown: 5, synergySkill: 'ombra_letale' },
  { id: 'esecuzione',          name: 'Esecuzione',           icon: '⚰️',
    ...
    cooldown: 5, synergySkill: 'colpo_mortale' },
  ...
  { id: 'fendente_poderoso',   name: 'Fendente Poderoso',    icon: '🪓',
    ...
    cooldown: 2, synergySkill: 'posizione_difensiva' },
  { id: 'posizione_difensiva', name: 'Posizione Difensiva',  icon: '🛡️',
    ...
    cooldown: 2, synergySkill: 'fendente_poderoso' },
  ...
  { id: 'tempesta_lame',       name: 'Tempesta di Lame',     icon: '🌀',
    ...
    cooldown: 4, synergySkill: 'urlo_guerra' },
  { id: 'colpo_devastante',    name: 'Colpo Devastante',     icon: '💥',
    ...
    cooldown: 4, synergySkill: 'tempesta_lame' },
  { id: 'resistenza_totale',   name: 'Resistenza Totale',    icon: '🦾',
    ...
    cooldown: 5, synergySkill: 'secondo_vento' },
  { id: 'assalto_finale',      name: 'Assalto Finale',       icon: '🌪️',
    ...
    cooldown: 5, synergySkill: 'colpo_devastante' },
  ...
  { id: 'palla_fuoco',         name: 'Palla di Fuoco',       icon: '🔥',
    ...
    cooldown: 2, synergySkill: 'scudo_arcano' },
  { id: 'scudo_arcano',        name: 'Scudo Arcano',         icon: '✨',
    ...
    cooldown: 2, synergySkill: 'palla_fuoco' },
  ...
  { id: 'saetta_arcana',       name: 'Saetta Arcana',        icon: '⚡',
    ...
    cooldown: 3, synergySkill: 'dardo_ghiaccio' },
  { id: 'drena_arcano',        name: 'Drenaggio Arcano',     icon: '🌀',
    ...
    cooldown: 4, synergySkill: 'saetta_arcana' },
  { id: 'congelamento',        name: 'Congelamento',         icon: '🧊',
    ...
    cooldown: 4, synergySkill: 'drena_arcano' },
  { id: 'meteora',             name: 'Meteora Arcana',       icon: '☄️',
    ...
    cooldown: 5, synergySkill: 'congelamento' },
  { id: 'arcano_supremo',      name: 'Arcano Supremo',       icon: '🌌',
    ...
    cooldown: 5, synergySkill: 'meteora' },
  ...
  { id: 'colpo_sacro',         name: 'Colpo Sacro',          icon: '⚜️',
    ...
    cooldown: 2, synergySkill: 'imponiti' },
  { id: 'imponiti',            name: 'Imponiti',             icon: '✝️',
    ...
    cooldown: 2, synergySkill: 'colpo_sacro' },
  ...
  { id: 'aura_protezione',     name: 'Aura di Protezione',   icon: '🔰',
    ...
    cooldown: 4, synergySkill: 'guarigione_divina' },
  { id: 'punizione_divina',    name: 'Punizione Divina',     icon: '⚡',
    ...
    cooldown: 4, synergySkill: 'aura_protezione' },
  { id: 'invocazione_sacra',   name: 'Invocazione Sacra',    icon: '👼',
    ...
    cooldown: 5, synergySkill: 'punizione_divina' },
  { id: 'ira_divina',          name: 'Ira Divina',           icon: '☀️',
    ...
    cooldown: 5, synergySkill: 'invocazione_sacra' },
  ...
  { id: 'folgore_naturale',    name: 'Folgore Naturale',     icon: '⚡',
    ...
    cooldown: 2, synergySkill: 'rigenerazione' },
  { id: 'rigenerazione',       name: 'Rigenerazione',        icon: '🌿',
    ...
    cooldown: 2, synergySkill: 'folgore_naturale' },
  ...
  { id: 'tempesta_spine',      name: 'Tempesta di Spine',    icon: '🌵',
    ...
    cooldown: 4, synergySkill: 'radici_intrecciate' },
  { id: 'forma_bestiale',      name: 'Forma Bestiale',       icon: '🐺',
    ...
    cooldown: 4, synergySkill: 'tempesta_spine' },
  { id: 'tempesta_tuoni',      name: 'Tempesta di Tuoni',    icon: '🌩️',
    ...
    cooldown: 5, synergySkill: 'forma_bestiale' },
  { id: 'cataclisma',          name: 'Cataclisma Naturale',  icon: '🌋',
    ...
    cooldown: 5, synergySkill: 'tempesta_tuoni' },
  ...
  { id: 'parola_potere',       name: 'Parola di Potere',     icon: '📖',
    ...
    cooldown: 4, synergySkill: 'benedizione' },
  { id: 'cura_maggiore',       name: 'Cura Maggiore',        icon: '💖',
    ...
    cooldown: 4, synergySkill: 'parola_potere' },
  { id: 'martello_sacro',      name: 'Martello Sacro',       icon: '⚒️',
    ...
    cooldown: 5, synergySkill: 'cura_maggiore' },
  { id: 'miracolo',            name: 'Miracolo',             icon: '🌈',
    ...
    cooldown: 5, synergySkill: 'martello_sacro' },
];
